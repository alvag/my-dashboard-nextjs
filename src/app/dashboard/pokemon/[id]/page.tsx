...
const getPokemon = async ( id: string ): Promise<Pokemon> => {
    try {
        return await fetch( `https://pokeapi.co/api/v2/pokemon/${ id }`, { cache: 'force-cache' } )
            .then( res => res.json() );
    } catch ( e ) {
        notFound();
    }
            ...
            <div
                        ...
                        <span className="text-base font-medium text-navy-700 flex">
              {
                  pokemon.weight
                    ...
                    <div
                        className="flex flex-col justify-center rounded-2xl bg-white bg-clip-border px-3 py-4  drop-shadow-lg">
